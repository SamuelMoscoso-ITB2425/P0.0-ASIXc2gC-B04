...
2. [Requesitos minimos del Sistema](#Requisitos-minimos-del-sistema)
3. [Pagina Web]()
...
- Pagina Web: Podra consultar información sobre equipamientos educativos
- Servidor SFTP: Podra transferir archivos entre usuarios de manera segura

## 2. Requesitos minimos del Sistema
